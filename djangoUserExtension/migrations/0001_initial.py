    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bankingaccountref', models.CharField(blank=True, max_length=60, null=True, verbose_name='Reference to Banking Account')),
                ('addresser', models.CharField(blank=True, max_length=200, null=True, verbose_name='Addresser')),
                ('fopConfigurationFile', filebrowser.fields.FileBrowseField(blank=True, max_length=200, null=True, verbose_name='FOP Configuration File')),
                ('footerTextsalesorders', models.TextField(blank=True, null=True, verbose_name='Footer Text On Salesorders')),
                ('headerTextsalesorders', models.TextField(blank=True, null=True, verbose_name='Header Text On Salesorders')),
                ('headerTextpurchaseorders', models.TextField(blank=True, null=True, verbose_name='Header Text On Purchaseorders')),
                ('footerTextpurchaseorders', models.TextField(blank=True, null=True, verbose_name='Footer Text On Purchaseorders')),
                ('pagefooterleft', models.CharField(blank=True, max_length=40, null=True, verbose_name='Page Footer Left')),
                ('pagefootermiddle', models.CharField(blank=True, max_length=40, null=True, verbose_name='Page Footer Middle')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('defaultTemplateSet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='djangoUserExtension.TemplateSet')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='db_reltemplatepurchaseconfirmation', to='djangoUserExtension.XSLFile', verbose_name='XSL File for Purchase Confirmation'),
        ),
        migrations.AddField(
            model_name='templateset',
