...
class TaskPlannedEffort(TestCase):
    ...
    def test_planned_effort(self):
        ...
        self.assertEqual(
            (self.test_1st_task.planned_costs(reporting_period=self.test_reporting_period)).__str__(), "420")
        self.assertEqual(
            (self.test_2nd_task.planned_effort()).__str__(), "8.00")
        self.assertEqual(
            (self.test_2nd_task.planned_costs(reporting_period=self.test_reporting_period)).__str__(), "960")
