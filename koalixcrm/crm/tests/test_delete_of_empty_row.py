...
class TimeTrackingWorkEntry(StaticLiveServerTestCase):
    ...
    def test_delete_of_new_blank_row(self):
        ...
        project = selenium.find_element('xpath', '//*[@id="id_form-2-project"]')
        datetime_start_date = selenium.find_element('xpath', '//*[@id="id_form-2-datetime_start_0"]')
        datetime_start_time = selenium.find_element('xpath', '//*[@id="id_form-2-datetime_start_1"]')
        datetime_stop_date = selenium.find_element('xpath', '//*[@id="id_form-2-datetime_stop_0"]')
        datetime_stop_time = selenium.find_element('xpath', '//*[@id="id_form-2-datetime_stop_1"]')
        description = selenium.find_element('xpath', '//*[@id="id_form-2-description"]')
        ...
        task = selenium.find_element('xpath', '//*[@id="id_form-2-task"]/option[text()="'+self.test_1st_task.title+'"]')
        task.click()
