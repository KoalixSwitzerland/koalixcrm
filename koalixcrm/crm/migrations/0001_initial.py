    ...
    operations = [
        ...
        CreateModelIfNotExists(
            ...
            fields=[
                ...
                ('subdivision_code', models.CharField(blank=True, help_text='e.g. ZH for Kanton Zürich, BY for Bayern — used for regional public holidays', max_length=3, null=True, verbose_name='Subdivision Code (ISO 3166-2 suffix)')),
