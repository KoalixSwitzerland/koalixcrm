            ...
            <fo:page-sequence master-reference="simple">
                ...
                <fo:flow flow-name="xsl-region-body">
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell>
                                    ...
                                    <fo:block font-size="7pt"
                                              ...
                                              text-align="left">
                                        <xsl:value-of
                                                select="substring(object[@model='crm.paymentreminder']/field[@name='payable_until'], 9, 2)"/><xsl:text>.</xsl:text><xsl:value-of
                                            select="substring(object[@model='crm.paymentreminder']/field[@name='payable_until'], 6, 2)"/><xsl:text>.</xsl:text><xsl:value-of
                                            select="substring(object[@model='crm.paymentreminder']/field[@name='payable_until'], 1, 4)"/>
                                    </fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">
                                    ...
                                    <xsl:choose>
                                        <xsl:when
                                            ...
                                            <fo:block font-size="9pt"
                                                      ...
                                                      text-align="left">
                                                <xsl:value-of
                                                        select="object[@model='crm.postaladdress']/field[@name='prename']"/><xsl:text> </xsl:text>
                                                <xsl:value-of
                                                        select="object[@model='crm.postaladdress']/field[@name='name']"/>
                                            </fo:block>
                                            <xsl:choose>
                                                <xsl:when
                                                        test="object[@model='crm.postaladdress']/field[@name='addressline1']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of
                                                                select="object[@model='crm.postaladdress']/field[@name='addressline1']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <xsl:choose>
                                                <xsl:when
                                                        test="object[@model='crm.postaladdress']/field[@name='addressline2']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of
                                                                select="object[@model='crm.postaladdress']/field[@name='addressline2']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <xsl:choose>
                                                <xsl:when
                                                        test="object[@model='crm.postaladdress']/field[@name='addressline3']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of
                                                                select="object[@model='crm.postaladdress']/field[@name='addressline3']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <xsl:choose>
                                                <xsl:when
                                                        test="object[@model='crm.postaladdress']/field[@name='addressline4']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of
                                                                select="object[@model='crm.postaladdress']/field[@name='addressline4']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <fo:block font-size="9pt"
                                                ...
                                                <xsl:value-of
                                                    ...
                                                    select="object[@model='crm.postaladdress']/field[@name='zipcode']"/>
                                                <xsl:text> </xsl:text>
                                                <xsl:value-of
                    ...
                    <fo:block font-size="15pt"
                              ...
                              margin-top="2cm">
                        Offerte
                        <xsl:value-of select="object[@model='crm.paymentreminder']/field[@name='iteration_number']"/> -
