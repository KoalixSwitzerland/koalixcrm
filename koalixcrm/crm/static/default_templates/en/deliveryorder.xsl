  ...
  <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<fo:table-row >
          ...
          <fo:table-cell>
			...
			<fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left">LIF-<xsl:value-of select="object[@model='crm.salesdocument']/@pk"/></fo:block>
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
            <fo:block font-size="7pt"
            ...
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left"><xsl:value-of select="substring(object[@model='crm.deliverynote']/field[@name='delivery_date'], 9, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(object[@model='crm.deliverynote']/field[@name='delivery_date'], 6, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(object[@model='crm.deliverynote']/field[@name='delivery_date'], 1, 4)"/></fo:block>
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
            <fo:block font-size="7pt"
       ...
       <fo:block font-size="15pt"
                 ...
                 font-weight="bold"
                 margin-top="2cm">
        Delivery note <xsl:value-of select="object[@model='crm.salesdocument']/field[@name='description']"/>
       </fo:block>
       <xsl:for-each select="object[@model='crm.textparagraphinsalesdocument']">
          <xsl:choose>
