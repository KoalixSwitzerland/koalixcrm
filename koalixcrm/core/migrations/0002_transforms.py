    ...
    operations = [
        CreateModelIfNotExists(
            ...
            fields=[
                ...
                ('from_currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='db_reltransformfromcurrency', to='core.currency', verbose_name='From Currency')),
                ('to_currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='db_reltransformtocurrency', to='core.currency', verbose_name='To Currency')),
        ...
        CreateModelIfNotExists(
            ...
            fields=[
                ...
                ('from_unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='db_reltransfromfromunit', to='core.unit', verbose_name='From Unit')),
                ...
                ('to_unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='db_reltransfromtounit', to='core.unit', verbose_name='To Unit')),
            ],
            options={
