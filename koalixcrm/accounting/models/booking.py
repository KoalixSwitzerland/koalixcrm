...
class Booking(models.Model):
    ...
    from_account = models.ForeignKey(
        "Account", on_delete=models.CASCADE, verbose_name=_("From Account"), related_name="db_booking_fromaccount"
    )
    to_account = models.ForeignKey(
        "Account", on_delete=models.CASCADE, verbose_name=_("To Account"), related_name="db_booking_toaccount"
    )
    ...
    booking_reference = models.ForeignKey(
        "contract_object_management.Invoice",
    ...
    accounting_period = models.ForeignKey(
        "AccountingPeriod", on_delete=models.CASCADE, verbose_name=_("AccountingPeriod")
    )
    staff = models.ForeignKey(
        ...
        blank=True,
        verbose_name=_("Reference Staff"),
        related_name="db_booking_refstaff",
    )
...
class OptionBooking(admin.ModelAdmin):
    list_display = ("from_account", "to_account", "amount", "booking_date_only", "staff")
    fieldsets = (
        (
            _("Basic"),
            {
