    ...
    operations = [
        ...
        CreateModelIfNotExists(
            ...
            options={
                ...
                'db_table': 'crm_postaladdress',
            },
        ),
        CreateModelIfNotExists(
            name='CallForContact',
            fields=[
                ('call_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='contacts.call')),
        ...
        CreateModelIfNotExists(
            ...
            fields=[
                ('contact_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='contacts.contact')),
                ('offers_shipment_to_customers', models.BooleanField(db_column='offersShipmentToCustomers', verbose_name='Offers Shipment to Customer')),
            ],
            options={
        ...
        CreateModelIfNotExists(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='person_association', to='contacts.contact')),
            ],
            options={
                'verbose_name': 'Contacts',
                'verbose_name_plural': 'Contacts',
                'db_table': 'crm_contactpersonassociation',
            },
        ),
        CreateModelIfNotExists(
            ...
            options={
                ...
                'db_table': 'crm_emailaddressforcontact',
            },
