# Generated by Django 5.2.7 on 2026-04-04 19:02
...
def update_content_types(apps, schema_editor):
    ...
    models_to_move = [
        'agreementstatus', 'agreementtype', 'estimationstatus',
        'resource', 'projectlinktype', 'projectstatus',
        'reportingperiodstatus', 'resourcetype', 'tasklinktype', 'taskstatus',
        'humanresource', 'project', 'genericprojectlink',
        'reportingperiod', 'resourcemanager', 'resourceprice',
        'task', 'estimation', 'agreement', 'generictasklink', 'work',
    ]
    for model_name in models_to_move:
        ContentType.objects.filter(
            app_label='crm', model=model_name
        ).update(app_label='reporting')
...
def revert_content_types(apps, schema_editor):
    ...
    for model_name in models_to_move:
        ContentType.objects.filter(
            app_label='reporting', model=model_name
