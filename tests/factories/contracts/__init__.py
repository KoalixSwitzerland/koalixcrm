...
from tests.factories.contracts.despatch_advice_factory import (
    StandardDespatchAdviceFactory,
)
from tests.factories.contracts.invoice_factory import StandardInvoiceFactory
from tests.factories.contracts.payment_reminder_factory import (
    StandardPaymentReminderFactory,
)
from tests.factories.contracts.purchase_order_factory import (
    StandardPurchaseOrderFactory,
)
