...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table('accounting_productcategorie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('profitAccount', self.gf('django.db.models.fields.related.ForeignKey')(related_name='db_profit_account',
                                                                                    to=orm['accounting.Account'])),
            ('lossAccount', self.gf('django.db.models.fields.related.ForeignKey')(related_name='db_loss_account',
                                                                                  to=orm['accounting.Account'])),
        ))
        ...
        db.create_table('accounting_booking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fromAccount', self.gf('django.db.models.fields.related.ForeignKey')(related_name='db_booking_fromaccount',
                                                                                  to=orm['accounting.Account'])),
            ('toAccount', self.gf('django.db.models.fields.related.ForeignKey')(related_name='db_booking_toaccount',
                                                                                to=orm['accounting.Account'])),
            ...
            ('bookingReference',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crm.Invoice'], null=True, blank=True)),
            ('bookingDate', self.gf('django.db.models.fields.DateTimeField')()),
            ('accountingPeriod',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.AccountingPeriod'])),
            ('staff',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='db_booking_refstaff', blank=True,
                                                                   to=orm['auth.User'])),
            ...
            ('lastmodifiedby',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='db_booking_lstmodified', blank=True,
                                                                   to=orm['auth.User'])),
        ))
    ...
    models = {
        ...
        'accounting.booking': {
            ...
            'accountingPeriod': (
            'django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounting.AccountingPeriod']"}),
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'bookingDate': ('django.db.models.fields.DateTimeField', [], {}),
            'bookingReference': ('django.db.models.fields.related.ForeignKey', [],
                                 {'to': "orm['crm.Invoice']", 'null': 'True', 'blank': 'True'}),
            ...
            'fromAccount': ('django.db.models.fields.related.ForeignKey', [],
                            {'related_name': "'db_booking_fromaccount'", 'to': "orm['accounting.Account']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodification': (
            'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'lastmodifiedby': ('django.db.models.fields.related.ForeignKey', [],
                               {'related_name': "'db_booking_lstmodified'", 'blank': 'True', 'to': "orm['auth.User']"}),
            'staff': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'db_booking_refstaff'", 'blank': 'True', 'to': "orm['auth.User']"}),
            'toAccount': ('django.db.models.fields.related.ForeignKey', [],
                          {'related_name': "'db_booking_toaccount'", 'to': "orm['accounting.Account']"})
        },
        'accounting.productcategorie': {
            'Meta': {'object_name': 'ProductCategorie'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lossAccount': ('django.db.models.fields.related.ForeignKey', [],
                            {'related_name': "'db_loss_account'", 'to': "orm['accounting.Account']"}),
            'profitAccount': ('django.db.models.fields.related.ForeignKey', [],
                              {'related_name': "'db_profit_account'", 'to': "orm['accounting.Account']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'auth.group': {
        ...
        'crm.contract': {
            ...
            'dateofcreation': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'defaultSupplier': ('django.db.models.fields.related.ForeignKey', [],
                                {'to': "orm['crm.Supplier']", 'null': 'True', 'blank': 'True'}),
            'defaultcurrency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['crm.Currency']"}),
            'defaultcustomer': ('django.db.models.fields.related.ForeignKey', [],
                                {'to': "orm['crm.Customer']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodification': (
            'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'lastmodifiedby': ('django.db.models.fields.related.ForeignKey', [],
                               {'related_name': "'db_contractlstmodified'", 'to': "orm['auth.User']"}),
            'staff': ('django.db.models.fields.related.ForeignKey', [],
                      {'blank': 'True', 'related_name': "'db_relcontractstaff'", 'null': 'True',
                       'to': "orm['auth.User']"})
        },
        'crm.currency': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rounding': ('django.db.models.fields.DecimalField', [],
        ...
        'crm.customer': {
            ...
            'contact_ptr': ('django.db.models.fields.related.OneToOneField', [],
                            {'to': "orm['crm.Contact']", 'unique': 'True', 'primary_key': 'True'}),
            'defaultCustomerBillingCycle': (
            'django.db.models.fields.related.ForeignKey', [], {'to': "orm['crm.CustomerBillingCycle']"}),
            'ismemberof': ('django.db.models.fields.related.ManyToManyField', [],
                           {'symmetrical': 'False', 'to': "orm['crm.CustomerGroup']", 'null': 'True', 'blank': 'True'})
        },
        ...
        'crm.invoice': {
            ...
            'derivatedFromQuote': ('django.db.models.fields.related.ForeignKey', [],
                                   {'to': "orm['crm.Quote']", 'null': 'True', 'blank': 'True'}),
            ...
            'salescontract_ptr': ('django.db.models.fields.related.OneToOneField', [],
                                  {'to': "orm['crm.SalesContract']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'crm.salescontract': {
            ...
            'description': (
            'django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'discount': ('django.db.models.fields.DecimalField', [],
                         {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'}),
            'externalReference': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastCalculatedPrice': ('django.db.models.fields.DecimalField', [],
                                    {'null': 'True', 'max_digits': '17', 'decimal_places': '2', 'blank': 'True'}),
            'lastCalculatedTax': ('django.db.models.fields.DecimalField', [],
                                  {'null': 'True', 'max_digits': '17', 'decimal_places': '2', 'blank': 'True'}),
            'lastPricingDate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'lastmodification': (
            'django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'lastmodifiedby': ('django.db.models.fields.related.ForeignKey', [],
                               {'blank': "'True'", 'related_name': "'db_lstscmodified'", 'null': 'True',
                                'to': "orm['auth.User']"}),
            'staff': ('django.db.models.fields.related.ForeignKey', [],
                      {'blank': 'True', 'related_name': "'db_relscstaff'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'crm.supplier': {
