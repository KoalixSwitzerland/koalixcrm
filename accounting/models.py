...
class Account(models.Model):
    ...
    def sumOfAllBookingsBeforeAccountingPeriod(self, currentAccountingPeriod):
        ...
        for accountingPeriod in accountingPeriods:
          sum = sum + self.allBookingsInAccountingPeriod(fromAccount = False, accountingPeriod = accountingPeriod) - self.allBookingsInAccountingPeriod(fromAccount = True, accountingPeriod = accountingPeriod)
        if (self.accountType == 'S' or self.accountType == 'L'):
          sum = 0 - sum
        return sum
