...
urlpatterns = i18n_patterns("",
    ...
    url(r'^billingcycles/edit/(?P<pk>\d+)/$', EditBillingCycle.as_view(), name='billingcycle_edit'),
    url(r'^billingcycles/delete/(?P<pk>\d+)/$', DeleteBillingCycle.as_view(), name='billingcycle_delete'),
