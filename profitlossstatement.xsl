    ...
    <fo:page-sequence master-reference="simple">
      <fo:static-content flow-name="xsl-region-before" >
        ...
        <fo:block font-size="13pt"
              ...
              text-align="left"
              font-weight="bold">
        Erfolgsrechnung der koalix Riedener Geschäftsjahr: <xsl:value-of select="calculationUnitName"/>
       </fo:block>
        <fo:block font-size="13pt"
              font-family="BitstreamVeraSans"
              color="black"
              text-align="left"
              font-weight="bold">
        für den Zeitraum vom: <xsl:value-of select="calculationUnitFrom"/> bis: <xsl:value-of select="calculationUnitTo"/>
       </fo:block>
      </fo:static-content>
