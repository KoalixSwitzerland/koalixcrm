...
#
# ADMIN_TOOLS_INDEX_DASHBOARD = 'koalixcrm.dashboard.CustomIndexDashboard'
...
#
# ADMIN_TOOLS_APP_INDEX_DASHBOARD = 'koalixcrm.dashboard.CustomAppIndexDashboard'

class CustomAppIndexDashboard(AppIndexDashboard):
    """
    Custom app index dashboard for koalixcrm.
    """
