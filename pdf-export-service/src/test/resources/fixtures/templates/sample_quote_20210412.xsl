                        ...
                        <fo:table-body font-size="7pt"
                            ...
                            <fo:table-row >
                                ...
                                <fo:table-cell>
                                    ...
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">713031600_Appendix_<xsl:value-of select="object[@model='crm.salesdocument']/@pk"/></fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
                                    <fo:block font-size="7pt"
                                    ...
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left">
                                        <xsl:value-of select="substring(object[@model='crm.quote']/field[@name='valid_until'], 9, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(object[@model='crm.quote']/field[@name='valid_until'], 6, 2)"/><xsl:text>.</xsl:text><xsl:value-of select="substring(object[@model='crm.quote']/field[@name='valid_until'], 1, 4)"/></fo:block>
                                    <fo:block font-size="7pt"
                                              font-family="BitstreamVeraSans"
                                              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
                                    <fo:block font-size="7pt"
                                ...
                                <fo:table-cell>
                                    ...
                                    <xsl:choose>
                                        <xsl:when  test="object[@model='crm.postaladdressforcontact']/field[@name='purpose']">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="object[@model='crm.postaladdress']/field[@name='address_line_1']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of select="object[@model='crm.postaladdress']/field[@name='address_line_1']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <xsl:choose>
                                                <xsl:when test="object[@model='crm.postaladdress']/field[@name='address_line_2']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of select="object[@model='crm.postaladdress']/field[@name='address_line_2']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <xsl:choose>
                                                <xsl:when test="object[@model='crm.postaladdress']/field[@name='address_line_3']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of select="object[@model='crm.postaladdress']/field[@name='address_line_3']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <xsl:choose>
                                                <xsl:when test="object[@model='crm.postaladdress']/field[@name='address_line_4']">
                                                    <fo:block font-size="9pt"
                                                              font-family="BitstreamVeraSans"
                                                              text-align="left">
                                                        <xsl:value-of select="object[@model='crm.postaladdress']/field[@name='address_line_4']"/>
                                                    </fo:block>
                                                </xsl:when>
                                            </xsl:choose>
                                            <fo:block font-size="9pt"
