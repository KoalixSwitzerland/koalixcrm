...
# from crm.impex import ContractResource, CurrencyResource, CustomerBillingCycleResource, CustomerGroupResource, \
#     CustomerResource, InvoiceResource, ProductResource, PurchaseOrderResource, QuoteResource, SalesContractResource, \
#     SupplierResource, TaxResource, UnitResource
...
# #
# #
# # class OptionContract(admin.ModelAdmin, ImportExportMixin):
...
# #
# #
# # class OptionInvoice(admin.ModelAdmin, ImportExportMixin):
# #     list_display = (
...
# #
# #
# # class OptionQuote(admin.ModelAdmin, ImportExportMixin):
# #     list_display = (
...
# #
# #
# # class OptionPurchaseOrder(admin.ModelAdmin, ImportExportMixin):
# #     list_display = (
...
# #
# #
# class OptionCustomer(admin.ModelAdmin, ImportExportMixin):
#     list_display = ('id', 'firstname', 'name', 'billingcycle', 'lastmodifiedby')
...
# #
# #
# # class OptionCustomerGroup(admin.ModelAdmin, ImportExportMixin):
...
# #
# #
# # class OptionSupplier(admin.ModelAdmin, ImportExportMixin):
# #     list_display = ('id', 'name')
# #     fieldsets = (('', {'fields': ('name',)}),)
# #     # inlines = [PostalAddress, PhoneAddress, EmailAddress]
# #     allow_add = True
...
# #
# #
# # class OptionUnit(admin.ModelAdmin, ImportExportMixin):
...
# #
# #
# # class OptionCurrency(admin.ModelAdmin, ImportExportMixin):
...
# #
# #
# # class OptionTax(admin.ModelAdmin, ImportExportMixin):
...
# #
# #
# # class OptionCustomerBillingCycle(admin.ModelAdmin, ImportExportMixin):
# #     list_display = ('id', 'timeToPaymentDate', 'name')
# #     fieldsets = (('', {'fields': ('timeToPaymentDate', 'name',)}),)
# #     resource_class = CustomerBillingCycleResource
# #
# #
