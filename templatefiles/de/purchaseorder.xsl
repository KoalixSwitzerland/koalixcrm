  ...
  <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
   ...
   <fo:table-row >
          ...
          <fo:table-cell>
            ...
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left">AU-<xsl:value-of select="object[@model='crm.purchaseorder']/field[@name='contract']"/></fo:block>
            <fo:block font-size="7pt"
              font-family="BitstreamVeraSans"
              text-align="left"><fo:leader leader-pattern="space"/></fo:block>
            <fo:block font-size="7pt"
        ...
        <fo:block font-size="15pt"
              ...
              font-weight="bold"
              margin-top="1cm">
        Rechnung RE-<xsl:value-of select="object[@model='crm.purchaseorder']/@pk"/>
       </fo:block>
        <fo:block font-size="9pt"
              font-family="BitstreamVeraSans"
              color="black"
