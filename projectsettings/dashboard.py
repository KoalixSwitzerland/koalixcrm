            ...
            children=[
                   modules.ModelList(
                    ...
                    modules.ModelList(
                        ...
                        column=1,
                        css_classes=('collapse closed',),
                        models=('koalixcrm.contacts.models.contact.CallForContact',
                                'koalixcrm.contacts.models.contact.VisitForContact',),
                    ),
                    modules.ModelList(
                        _('Products'),
                        column=1,
                    ...
                    modules.ModelList(
                        ...
                        column=1,
                        css_classes=('collapse closed',),
                        models=('koalixcrm.contacts.models.customer.Customer',
                                'koalixcrm.contacts.models.supplier.Supplier',
                                'koalixcrm.contacts.models.person.Person',),
                    ),
                    modules.ModelList(
                        _('Accounting'),
                        column=1,
            ...
            children=[
                ...
                modules.ModelList(
                    ...
                    models=('koalixcrm.contacts.models.customer_billing_cycle.CustomerBillingCycle',
                            'koalixcrm.contacts.models.customer_group.CustomerGroup',),
                ),
                modules.ModelList(
                    _('Product settings'),
                    column=1,
